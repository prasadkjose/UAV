   ...
   <style>
    ...
    $yaw=$_GET["yaw"];
                              ...
                              /*  $querry1= $sql->query("insert into cur_moist (value) VALUES ($val) ");
                                    ...
                                    $roll_mapped=270-$roll;
                                    $pitch_mapped=270-$pitch;
                                        $yaw_mapped=270-$yaw;

                                  
                                    $querry7= $sql->query("insert into altitude (value) values ($pitch_mapped) ");
                                $querry6= $sql->query("insert into tilt (value) values ($roll_mapped) ");
    

                                $querry5= $sql->query("insert into gauge (value) values ($yaw_mapped) ");
...
<div class="container">
  ...
  <table class="table">
    ...
    function refresh(){
        $('#bod').load('dashdisp.php', function(){
